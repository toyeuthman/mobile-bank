...
const account1 = {
  owner: 'Seyi Owoeye',
  movements: [2000, 4550, -400, 30000, -650, -1300, 7000, 1300],
  interestRate: 1.2, // %
  pin: 1111,
};
...
const account2 = {
  owner: 'Toye Uthman',
  movements: [5000, 3400, -150, -790, -3210, 10000, 8500, -30],
  interestRate: 1.5,
  pin: 2222,
};

const account3 = {
  owner: 'Rhoda Oyinlola',
  movements: [20000, -200, 3400, -300, -20, 5000, 4000, -460],
  interestRate: 0.7,
  pin: 3333,
};

const account4 = {
  owner: 'Abass Olalekan ',
  movements: [4300, 10000, 7000, 5000, -90, 1200],
  interestRate: 1,
  pin: 4444,
};
const account5 = {
  owner: 'Karen Chisom',
  movements: [100, 100, 900, 50, 9000, 8500],
  interestRate: 1,
  pin: 5555,
};
const account6 = {
  owner: 'Olumide Ariyibi',
  movements: [10000, -1000, 9000, 50, 90,7000, 8000],
  interestRate: 1,
  pin: 6666,
};
